    ...
    story.append(
        table(
            [
                ...
                [
                    "Developer",
                    "Uruchamia projekt lokalnie, rozwija frontend/backend, pisze testy i utrzymuje integracje z usługami AI.",
                ],
            ],
            [3.2 * cm, 12.1 * cm],
            s["BodyCustom"],
    ...
    story.append(
        table(
            [
                ...
                ["/api/devices", "Zarządzanie urządzeniami oraz relacjami z markami, typami i dokumentami."],
                ["/api/attachments", "Przesyłanie PDF, pobieranie dokumentów, łączenie ich z urządzeniami i usuwanie."],
                ["/api/threads", "Wątki rozmów, wysyłanie wiadomości, streaming odpowiedzi i transkrypcja audio."],
                ["/api/messages", "Pobieranie wiadomości oraz danych konwersacji."],
                ["/api/chunks", "Dostęp do fragmentów dokumentacji oraz ich usuwanie."],
                ["/api/images", "Serwowanie obrazów i zasobów powiązanych z dokumentacją."],
    ...
    story.append(
        bullets(
            [
                ...
                "Zmiany powinny przechodzić lint, format-check oraz testy automatyczne.",
